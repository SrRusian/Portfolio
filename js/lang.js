const translations = {
  en: {
    ...
    certificate_t7: "SQL (Intermediate) Certificate",
    certificate_i7: "<strong>Issued by:</strong> Hacker Rank",
    certificate_d7: "<strong>Date:</strong> Aug 17, 2025",
    certificate_id7: "<strong>ID:</strong> 4B0CC3531690",
  ...
  es: {
    ...
    certificate_t7: "SQL (Intermedio) Certificado",
    certificate_i7: "<strong>Emitido por:</strong> Hacker Rank",
    certificate_d7: "<strong>Fecha:</strong> 17 de agosto de 2025",
    certificate_id7: "<strong>ID:</strong> 4B0CC3531690",
